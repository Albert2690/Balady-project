          ...
          <form action="#">
            <div className="grid grid-cols-6 gap-6">
              <div
                ...
                dir="rtl"
              >
                <span tabIndex={0} onClick={handleClick} className="shadow-sm text-start mt-2  bg-gray-50 border border-gray-300 text-[#3c3c3b] h-[51px] text-[13px]   rounded-lg focus:ring-[#07706C] focus:border-[#07706C] focus:text-[#07706C] block w-full p-3">
                  {data?.honesty}{" "}
                </span>

                <label
                  htmlFor="municipal"
                  className="absolute font-bold text-[100%] text-black -top-2.5 right-2.5 bg-white px-1 flex items-center"
                >
                  الامانة
                </label>
              </div>
              ...
              required
            /> */}
                <span  tabIndex={0} onClick={handleClick} className="shadow-sm h-[51px] mt-2  text-start bg-[#f3f6f7] border border-gray-300 text-[#3c3c3b] text-[13px] rounded-lg focus:ring-[#07706C] focus:border-[#07706C] focus:text-[#07706C] block w-full p-3">
                  {data?.municipal}{" "}
                </span>
                <label
                  htmlFor="municipal"
              ...
              >
                ...
                <span
                  onClick={handleClick}
                  tabIndex={0}
                  className="shadow-sm text-start h-[51px] mt-2  bg-[#f3f6f7] border border-gray-300 text-[#3c3c3b] text-[13px]  rounded-lg focus:ring-[#07706C] focus:border-[#07706C] focus:text-[#07706C] block w-full p-2.5"
                >
                  {data?.id_Number}{" "}
                </span>
                <label
              ...
              >
                {" "}
                <span  tabIndex={0} onClick={handleClick} className="shadow-sm h-[51px] mt-2  text-start bg-[#f3f6f7]  border border-gray-300 text-[#3c3c3b] text-[13px]  rounded-lg focus:ring-[#07706C] focus:border-[#07706C] focus:text-[#07706C] block w-full p-2.5">
                  {data?.sex}{" "}
                </span>
                <label
                  htmlFor="municipal"
              ...
              >
                {" "}
                <span  tabIndex={0} onClick={handleClick} className="shadow-sm h-[51px] mt-2  text-start bg-[#f3f6f7]  border border-gray-300 text-[#3c3c3b] text-[13px]  rounded-lg ffocus:ring-[#07706C] focus:border-[#07706C] focus:text-[#07706C] block w-full p-2.5">
                  {data?.nationality}{" "}
                </span>
                <label
                  htmlFor="municipal"
              ...
              <div
                ...
                dir="rtl"
              >
                <span  tabIndex={0} onClick={handleClick} className="shadow-sm h-[51px] text-start bg-[#f3f6f7]  border border-gray-300 text-[#3c3c3b] text-[13px]  rounded-lg focus:ring-[#07706C] focus:border-[#07706C] focus:text-[#07706C] block w-full p-2.5">
              ...
              <div
                ...
                dir="rtl"
              >
                <span  tabIndex={0} onClick={handleClick} className="shadow-sm mt-2  text-start h-[51px] bg-[#f3f6f7]  border border-gray-300 text-[#3c3c3b] text-[13px]  rounded-lg focus:ring-[#07706C] focus:border-[#07706C] focus:text-[#07706C] block w-full p-2.5">
              ...
              <div
                ...
                dir="rtl"
              >
                <span tabIndex={0} onClick={handleClick} className="shadow-sm mt-2  h-[51px] text-start bg-[#f3f6f7]  border border-gray-300 text-[#3c3c3b] text-[13px]  rounded-lg  block w-full p-2.5">
